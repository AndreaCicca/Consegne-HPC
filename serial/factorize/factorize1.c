...
int main(int argc, char *argv[])
{
    ...
    ctx = BN_CTX_new();     // A BN_CTX is a structure that holds BIGNUM temporary variables used by library functions. 

   
    BN_generate_prime(p, num_bits, 1, NULL, NULL, status, NULL); // returns the prime number on success, NULL otherwise.
